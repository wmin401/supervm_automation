...
class install():
    ...
    def answers(self):
        ...
        try:
            ...
            self._ssh.commandExec('echo "OVEHOSTED_NETWORK/gateway=str:%s" >> /root/answers.conf'%(ADMIN_GATEWAY))
            ...
            self._ssh.commandExec('echo "OVEHOSTED_VM/enableFips=bool:False" >> /root/answers.conf') ## enableFips 추가
