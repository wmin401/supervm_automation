...
OVEHOSTED_STORAGE/storageDomainConnection=str:192.168.17.${ENGINE_NO}:/nfs
...
OVEHOSTED_VM/cloudinitInstanceHostName=str:master${MASTER_NO}.tmax.dom
...
OVEHOSTED_VM/cloudinitVMStaticCIDR=str:192.168.17.${MASTER_NO}/24
