...
class admin_external_provider:
    def __init__(self, webDriver):
        ...
        # self._type = 'VMware' # 환경에 따라 수정 필요
        # self._superVmDatacenter = 'Default' # 환경에 따라 수정 필요
        # self._vCenterIp = '192.168.178.180' # 환경에 따라 수정 필요
        # self._esxiIp = '192.168.178.30' # 환경에 따라 수정 필요
        # self._externalProviderDatacenter = 'Datacenter' # 환경에 따라 수정 필요
        # self._proxyHost = 'hypervm40.tmax.dom' # 환경에 따라 수정 필요
        # self._userName = 'tmax@vsphere.tmax' # 환경에 따라 수정 필요
        # self._userPassword = 'P@ssw0rd' # 환경에 따라 수정 필요
